...
// ── LocalStorage keys for payment-return state restore ────────────────────────
export const STORAGE = {
  tripParams: 'voyage_pending_trip_params',
  generatedRoute: 'voyage_pending_route',
  sessionId: 'voyage_pending_session_id',
  paymentId: 'voyage_pending_payment_id',
} as const;

export interface SavedTripParams {
  language: Language | null;
  destination: string;
  city: string;
  travelLevel: string;
